      ...
      <div className="text-center mb-8">
        {showFoodCart && (
          <p className="text-lg font-semibold">
            You are viewing the <span className="text-blue-500">Food Delivery</span> section. Here you can set an Active Status for bringing all the food requests.
          </p>
        )}
        {showServicesCart && (
          <p className="text-lg font-semibold">
            You are viewing the <span className="text-green-500">Other Services</span> section. Here you can set an Active Status for bringing other services.
          </p>
        )}
      </div>
