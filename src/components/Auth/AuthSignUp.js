...
const Auth = () => {
  ...
  >
    ...
    <div className={`relative mt-16 w-full flex justify-center`}>
      {loading && (
        <div className="absolute inset-0  bg-opacity-60 flex flex-col justify-center items-center z-10">
          <Loader />
      ...
      <div
        className={`flex flex-col items-center w-[300px] p-3 rounded shadow-md ${
